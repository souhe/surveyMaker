...
var MultipleQuestionInViewMode = React.createClass({
    propTypes: {
    ...
    var curr = this;
        var answers = this.props.question.questionData.map(function(answer){
            return (
                <div><label><input type="checkbox" name={curr.props.question.id} />{answer}</label></div>
            );
        });
        return (
            <div>
...
module.exports = MultipleQuestionInViewMode;